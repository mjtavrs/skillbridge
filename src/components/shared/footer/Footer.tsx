...
export default function Footer() {
    return (
        <div className="bg-white mt-12 px-5 pt-12 pb-6">
            <div className="laptop:flex laptop:justify-between laptop:mx-20 laptop:mb-8">
                <div>
                    <div>
                        <Image
                ...
                <div className="laptop:flex laptop:gap-32">
                    <div className="flex gap-8 laptop:gap-32 my-6 laptop:my-0">
            ...
            <div className="border-t-[1px] border-white_95 mx-20">
                <p className="text-sm text-grey_40 text-center pt-5 laptop:pt-8 leading-[150%]">
